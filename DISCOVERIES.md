...
| `4+12`, Δ=12 supplement | 3,185 | all colorable |
...
The original `4+12` file used the former global maximum-degree bound 11. Regeneration through Δ=12 gives **29,515** connected minimum-degree-2 graphs, exactly matching the hard-candidate count reported for `4+12` in the 2015 order-15 study; the **3,185** newly exposed Δ=12 candidates have now been independently regenerated by canonical SHA256, exactly classified, and audited. All are colorable, with zero timeouts, structural failures, hash mismatches, or solver disagreements.

The decomposed order-16 hard-candidate counts now reconcile exactly with the published filtered total of **12,322,367,816**: `26,330` Δ≤11 plus `3,185` Δ=12 in `4+12`, `5,158,975` in `5+11`, `291,917,907` in `6+10`, `3,604,370,591` in `7+9`, and a provisional `8,420,890,828` in `8+8`. The first four terms are complete and audited; `6+10`, all of `7+9`, and finalized/audited `8+8` remain. Published reductions cover disconnected graphs, pendant/isolated vertices, and parts of size at most3, so clean completion of those remaining classes will prove that every 16-vertex bipartite graph is interval-colorable.
